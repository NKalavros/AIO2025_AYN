#!/bin/bash
#SBATCH --job-name=aio_sigprofiler_assigner_ov_sbs # Job name
...
#SBATCH --output=/gpfs/data/courses/aio2025/adw9882/Analysis/output/logs/aio_sigprofiler_assigner_ov_sbs_%A_%a.log # Standard output and error log
...
OVFILE="${FILELOCATION}/ov_converted.txt"

## output location and make a folder if it doesn't exist
OVOUTLOC="${OUTPUTFILELOCATION}/SBS_SigAssigner_output_ov"
