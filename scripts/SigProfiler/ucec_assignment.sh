#!/bin/bash
#SBATCH --job-name=aio_sigprofiler_assigner_ucec_sbs # Job name
...
#SBATCH --output=/gpfs/data/courses/aio2025/adw9882/Analysis/output/logs/aio_sigprofiler_assigner_ucec_sbs_%A_%a.log # Standard output and error log
...
UCECFILE="${FILELOCATION}/ucec_converted.txt"

## output location and make a folder if it doesn't exist
UCECOUTLOC="${OUTPUTFILELOCATION}/SBS_SigAssigner_output_ucec"
