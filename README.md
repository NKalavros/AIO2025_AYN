...
2. Assign signatures on 2D threshold grid: [assign_grid_musical.py](https://github.com/yumibriones/AIO2025_AYN/blob/main/musical/scripts/assign_grid_musical.py)
